...
plot(row_stdx, row_stdy, col = "blue", pch = 16, xlab = "Współrzędna X", ylab = "Współrzędna Y", main = "Analiza korespondencji - Wiersze",  ylim = c(-4, 2.5), xlim=c(-1,9))
...
analiza_korespondencji <- function(tablica) {
  ...
  print(wynik$eig / sum(wynik$eig))
  
  cat("\nWspółrzędne wierszy:\n")
  print(wynik$rowcoord)
  
  cat("\nWspółrzędne kolumn:\n")
  print(wynik$colcoord)
  
  # Wykres
  plot(wynik, main = "Analiza korespondencji", col.row = "blue", col.col = "red")
  
  # Zwrócenie pełnego obiektu
  invisible(wynik)
}
analiza_korespondencji(tabela)
```
