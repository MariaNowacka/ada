...
ggplot(ankieta, aes(x= factor(PYT_1))) +
  ...
  theme_minimal()
```
Pytanie 1 brzmiało: "Jak bardzo zgadzasz się ze stwierdzeniem, ˙ ze firma zapewnia odpowiednie wsparcie i materiały umożliwiające skuteczne wykorzystanie w praktyce wiedzy zdobytej w trakcie szkoleń?" większość ankietowanych odpowiedziała 1 - "Zgadzam się" lub 2 - "Zdecydowanie się zgadzam". 
