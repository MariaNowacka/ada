...
## Zadanie 11
 Dla danych z pliku "ankieta.csv" korzystaj ˛ ac z funkcji z zadania 10., przyjmując
 1−α =0.95, zweryfikuj następujące hipotezy i sformułuj wnioski
...
```
P-valie mniejsze niż $\alpha$ czyli odrzucamy hipotezę zerową na rzecz hipotezy alternatywnej.
...
```
P-wartość jest większa niż $\alpha$, więc nie ma podstaw do odrzucenia hipotezy zerowej.

### 3. Prawdopodobieństwo, ˙ ze kobieta pracuje na stanowisku kierowniczym jest równe  prawdopodobieństwu, że mężczyzna pracuje na stanowisku kierowniczym.
